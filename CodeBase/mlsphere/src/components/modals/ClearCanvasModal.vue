  ...
  <div v-if="visible" class="home-modal" @click.self="onCancel">
    <div class="home-content">
      ...
      <div class="home-actions">
        <button class="home-action-btn ghost" @click="onConfirm">Yes, clear all</button>
        <button class="home-action-btn secondary" @click="onCancel">No, cancel</button>
      </div>
    </div>
  </div>
</template>
